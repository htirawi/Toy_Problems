// Write a function called  averageAge that accpets an array of objects and return the average ages 
...
function averageAge(people) { 
	...
	for(var key in people){
		if(people[key].age >= 18 && people[key].age<=50){
			arr.push(people[key].age)
			sum = sum +(people[key].age);
